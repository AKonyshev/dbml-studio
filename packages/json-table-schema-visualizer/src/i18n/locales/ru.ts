...
export const MESSAGES_RU: Record<MessageKey, string> = {
  ...
  "quickEdit.addedOutOfSight":
    "Колонка добавлена в файл. Таблица показана не полностью, поэтому новой колонки не видно. Поднимите уровень детализации.",
  "quickEdit.noColumnToAddBelow":
    "В таблице не объявлено ни одной колонки, поэтому добавлять новую не под что. Напишите первую в текстовом редакторе.",
  "quickEdit.pointAtAColumn":
    "Удаление работает по колонке: наведите на неё. Таблицу убирают в текстовом редакторе.",
  ...
  "action.deleteColumn": "Удалить колонку, на которую наведён указатель",
};
