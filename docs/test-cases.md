...
| 10a.9h  | Two columns of one name                   | Edit either of a table's two columns called `note`                       | Refused, and the box says why; neither line is touched                            | `columnOps.test.ts`          |
