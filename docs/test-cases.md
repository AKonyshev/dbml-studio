...
| 5.25 | Relation ends follow their own table             | Collapse one end of a relation                                                   | The line meets that table at its header and its other end still at the right column                             | `computeColIndexes.test.ts`                           |
